...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'silk_profile', (
            ...
            ('time_taken', self.gf('django.db.models.fields.FloatField')(null=True, blank=True)),
            ('file_path', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True)),
            ...
            ('func_name', self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True)),
    ...
    models = {
        u'silk.profile': {
            ...
            'file_path': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'blank': 'True'}),
            'func_name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '255', 'blank': 'True'}),
